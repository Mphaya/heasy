...
export DIR_ROOT=~/work/asr/beta
export DIR_EXP=$DIR_ROOT/test_data/experiment4
export DIR_SRC=$DIR_ROOT/heasy/src
export DIR_CFG=$DIR_ROOT/heasy/config

export LST_AUDIO_TRN_ORIG=$DIR_ROOT/heasy/experiment_template/audio_trn.lst
export LST_AUDIO_TST_ORIG=$DIR_ROOT/heasy/experiment_template/audio_tst.lst

export LST_TRANS_TRN_ORIG=$DIR_ROOT/heasy/experiment_template/trans_trn.lst
export LST_TRANS_TST_ORIG=$DIR_ROOT/heasy/experiment_template/trans_tst.lst

export DICT=$DIR_ROOT/dicts/cmu.sorted.dict

export DIR_SCRATCH=$DIR_EXP/tmp
export DIR_LOG=$DIR_EXP/log
...
# * - match 0 or more characters to be ignored
export AUDIO_CMEANMASK="*/lwazi/lwazi_english_1_0/audio/%%%/*"
...
export MFCC_CMEANMASK="*/lwazi/lwazi_english_1_0/mfccs/%%%/*"
...
export NUM_MIXES=8 # Number of times mixtures will be incremented
export MIX_INCREMENT=1 # If you change this, you have to do the logic yourself to set NUM_MIXES
...
export HADAPT_BASECLASS="" # TODO(User): This needs to be determined on a per experiment basis: Example: $DIR_EXP/models/hmm_33/regtree_2.base
export HADAPT_ADAPTKIND="BASE"
export HADAPT_SPLITTHRESH="0.0"
export HADAPT_SEMITIEDMACRO="" # TODO(User): Set at experiment level. Example: $DIR_EXP/models/hmm_33/SEMITIED
